 ...
 * @since 2016/08/04
 */
require_once './hotpepper-class.php';
            ...
            <div class="row">
                <div class="col-md-6">
                    <form method="get">
                        ...
                        <div class="form-group">
                            <label for="food_type">偏食タイプ</label>
                                <br><select name="food-type" size="1" id="food-type" class="form-control">
                                <option value=""></option>
                                <option value="">ケトジェニック</option>
                                <option value="">ローファット</option>
                                <option value="">ベジタリア</option>
                                <option value="">ヴィーガン</option>
                                </select>  
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">条件登録</button>
                        </div>
                    </form>
                </div>
            </div>
